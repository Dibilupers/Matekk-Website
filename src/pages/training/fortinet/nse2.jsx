        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8">
          ...
          <div>
            ...
            <p className="lg:w-[30vw] xl:w-lg text-gray-900">
             Deepen your understanding of cybersecurity by exploring common network threats,
             attack methods, and basic defense strategies. This course builds on foundational
             knowledge to prepare you for practical security challenges.
            </p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-y-3">
            ...
            <p>
              Building on the basics from NSE 1, this course expands your understanding of network 
              security concepts and threat prevention. It covers common cyber risks, attack methods, 
              and how security technologies help defend networks and users.
            </p>
            <p>
              Aligned with Fortinet NSE 2, this course strengthens your foundational knowledge and 
              prepares you for more advanced Fortinet training and real-world cybersecurity roles.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-y-5">
            ...
            <div className="grid flex-col lg:flex-col-2 gap-4">
              ...
              <div className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <p>Explain network protection using cryptography and endpoint security</p>
              </div>
              <div className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <p>Describe how secure network models like SD-WAN and SASE improve cybersecurity</p>
              </div>
              <p className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <span>Explain differences in securing physical, virtual, and cloud networks and endpoints</span>
              </p>
            </div>
          </section>
