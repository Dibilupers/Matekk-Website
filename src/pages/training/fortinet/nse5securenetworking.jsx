        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8">
          ...
          <div>
            ...
            <p className="lg:w-[30vw] xl:w-lg text-gray-900">
             Learn to utilize FortiNAC-F to gain full network visibility, control, 
             and automated security responses. This course provides hands-on experience 
             and best practices for implementing network security and automation.
            </p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-y-3">
            ...
            <p>
              In this course, you will gain practical skills to harness the capabilities of FortiNAC-F, 
              following best practices to achieve network visibility, access control, and automated security responses. 
              You will learn how to monitor devices, enforce policies, and strengthen overall network security.
            </p>
            <p>
              Aligned with Fortinet training, these fundamentals provide a strong foundation for implementing 
              effective network monitoring and security automation.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-y-5">
            ...
            <div className="grid flex-col lg:flex-col-2 gap-4">
              ...
              <div className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <p>Use control features for network access and automated policy enforcement</p>
              </div>
              <div className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
              ...
              <p className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <span>Combine visibility and control with security device integrations to automate threat responses</span>
              </p>
            </div>
          </section>
