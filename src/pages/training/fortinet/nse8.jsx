    ...
    <main className="flex flex-col h-full mx-[2.063rem] md:mx-16 lg:mx-16 xl:mx-[7.438rem] scroll-mt-18 space-y-10">
      ...
      <section className="relative pl-8 py-18 rounded-2xl shadow-lg flex flex-col gap-3 overflow-hidden min-h-62.5">
        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8">
          ...
          <div>
            {/* Course title */}
            <h1 className="text-[#1775EE]">NSE 8</h1>

            {/* Course description */}
            <p className="lg:w-[30vw] xl:w-lg text-gray-900">
              Participate in a two-day hands-on lab where you will configure a
              variety of Fortinet products to meet specific objectives. Learn
              from an FCX Cybersecurity certified instructor while practicing
              real-world scenarios across multiple Fortinet solutions.
            </p>
          </div>
