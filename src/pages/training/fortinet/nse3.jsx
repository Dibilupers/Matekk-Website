        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8">
          ...
          <div>
            ...
            <p className="lg:w-[30vw] xl:w-lg text-gray-900">
             Learn how to strengthen network security using key FortiGate features. 
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-y-3">
            ...
            <p>
              In this course, you will gain practical skills to strengthen network security using essential 
              FortiGate features. Through interactive simulations and guided demonstrations, you will learn
              how to perform basic configuration and operational tasks.
            </p>
            <p>
              Aligned with Fortinet NSE 3, this course builds your hands-on experience and prepares you for
              more advanced FortiGate concepts and security implementations.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-y-5">
            ...
            <div className="grid flex-col lg:flex-col-2 gap-4">
              ...
              <div className="flex items-center gap-2.5">
                <FaCircleCheck className="text-[#1775EE] shrink-0 w-6 h-6" />
                <p>Securely connect remote users to the corporate network via VPNs</p>
              </div>
