        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8">
          ...
          <div>
            ...
            <p className="lg:w-[30vw] xl:w-lg text-gray-900">
             Learn to deploy and manage FortiSASE to secure internet access and protect SaaS 
             applications for on-site and remote users. This course builds foundational knowledge 
             of FortiSASE and how to enforce security policies.
            </p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8">
        ...
        <div className="flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-y-3">
            ...
            <p>
              In this course, you will gain practical skills to implement and manage FortiSASE, delivering secure 
              internet access and protecting SaaS applications for both on-site and remote users. You will explore its core 
              architecture and security capabilities.
            </p>
            <p>
              Aligned with Fortinet training, you will learn how to apply security policies using endpoint profiles 
              and content inspection to ensure consistent and effective protection.
            </p>
          </section>
