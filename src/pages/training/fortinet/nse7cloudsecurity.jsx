...
import CloudSecurity from "../../../assets/nse-7-cloud-security.svg"; // Course badge image
...
export default function NSE7CloudSecurity() {
  ...
  const modules = [
    ...
    { title: "FortiCNAPP Monitoring", items: [] },
  ];
  ...
  return (
    <main className="flex flex-col h-full mx-[2.063rem] md:mx-16 lg:mx-16 xl:mx-[7.438rem] scroll-mt-18 space-y-10">
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8" id="services">
        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            <a
              href="https://training.fortinet.com/local/staticpage/view.php?page=nse_7_cloud_security"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium underline mt-2"
            >
              See the Official Fortinet NSE 7 Cloud Security Exam Details
            </a>
          </div>
        </aside>
      </div>
      ...
      <TrainingTemplateFooter
        ...
        description="Advance your networking career and prepare for the Fortinet NSE 7 Cloud Security exam."
      />
    </main>
  );
}
