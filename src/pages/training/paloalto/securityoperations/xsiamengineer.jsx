        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            {/* CHANGE: Download link text and URL */}
             <a
              href="https://www.paloaltonetworks.com/content/dam/pan/en_US/assets/pdf/datasheets/education/xsiam-engineer-datasheet.pdf"
              target="_blank"
              className="font-medium underline mt-2"
            >
              Download the Palo Alto Networks XSIAM Engineer Here
            </a>
          </div>
        </aside>
      </div>
