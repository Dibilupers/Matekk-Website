  ...
  return (
    <main className="flex flex-col h-full mx-[2.063rem] md:mx-16 lg:mx-16 xl:mx-[7.438rem] scroll-mt-18 space-y-10">
      ...
      <TrainingHeroBanner
        ...
        category="Palo Alto"
        title="Security Operations Professional"
        description="The Palo Alto Networks Certified Security Operations Professional
      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8" id="services">
        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            <a
              href="https://www.paloaltonetworks.com/content/dam/pan/en_US/assets/pdf/datasheets/education/secops-professional-datasheet.pdf"
              target="_blank"
              className="font-medium underline mt-2"
            >
              Download the Palo Alto Networks Security Operations Professional Here
            </a>
          </div>
        </aside>
      </div>
