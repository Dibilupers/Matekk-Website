  ...
  return (
    <main className="flex flex-col h-full mx-[2.063rem] md:mx-16 lg:mx-16 xl:mx-[7.438rem] scroll-mt-18 space-y-10">
      ...
      <TrainingHeroBanner
        ...
        title="Cyber Defense & Threat Hunting (SOC)"
        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            <a href="#" className="text-sm font-medium underline mt-2">
              Download the Cyber Defense & Threat Hunting Exam Topics Here
            </a>
          </div>
        </aside>
      </div>
      ...
      <TrainingTemplateFooter
        ...
        description="Advance your career and prepare for a SOC Analyst role with the Cyber Defense & Threat Hunting (CDTH) Bootcamp."
      />
    </main>
  );
}
