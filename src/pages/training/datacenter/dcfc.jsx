...
import ccnaHero from "../../../assets/data_centre_foundation_certificate.png"; // Hero banner background
import ccnaFooter from "../../../assets/data_centre_foundation_certificate2.png"; // Footer banner background
  ...
  return (
    <main className="flex flex-col h-full mx-[2.063rem] md:mx-16 lg:mx-16 xl:mx-[7.438rem] scroll-mt-18 space-y-10">
        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            <a href="#" className="font-medium underline mt-2">
              Download the DCFC Exam Basics here
            </a>
          </div>
        </aside>
      </div>
      ...
      <TrainingTemplateFooter
        ...
        description="Advance your networking career and prepare for the DCFC Enterprise exam."
      />
    </main>
  );
}
