      ...
      <div className="flex flex-col lg:flex-row justify-start items-start lg:items-stretch gap-6 lg:gap-8" id="services">
        ...
        <aside className="aside_contents">
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            {["IT Professionals", "Facilities Managers", "Data Centre Professionals", "Data Centre Operations & Support Staff"].map((job) => (
              <p key={job} className="flex gap-2 justify-left items-center">
                <IoIosCheckmarkCircleOutline className="text-[#1775EE] shrink-0 w-6 h-6 mt-0.5" />
                <span>{job}</span>
              </p>
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            {[
              ...
              "1–2 years of relevant experience recommended"
            ].map((item) => (
          ...
          <div className="p-6 rounded-2xl bg-[#EBF5FD] flex flex-col gap-2">
            ...
            <a href="https://www.epi-ap.com/uploads/file/training/CDCP_English.pdf" target="_blank" className="text-sm font-medium underline mt-2">
              Download the CDCP Exam Topics Here
            </a>
          </div>
        </aside>
      </div>
