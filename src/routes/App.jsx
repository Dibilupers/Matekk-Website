...
const CCNAAutomation = lazy(
  () => import("../pages/training/cisco/ccna/automation"),
);
const CCNACybersecurity = lazy(
  () => import("../pages/training/cisco/ccna/cybersecurity"),
);
const CCNPEnterprise = lazy(
  () => import("../pages/training/cisco/ccnp/enterprise"),
);
const CCNPDatacenter = lazy(
  () => import("../pages/training/cisco/ccnp/datacenter"),
);
const CCNPSecurity = lazy(
  () => import("../pages/training/cisco/ccnp/ccnp-security/security"),
);
const SNCF = lazy(
  () => import("../pages/training/cisco/ccnp/ccnp-security/300-710-SNCF-v1.1"),
);
const SISE = lazy(
  () => import("../pages/training/cisco/ccnp/ccnp-security/300-715-SISE-v1.1"),
);
const SVPN = lazy(
  () => import("../pages/training/cisco/ccnp/ccnp-security/300-730-SVPN-v1.1"),
);
const SDSI = lazy(
  () => import("../pages/training/cisco/ccnp/ccnp-security/300-745-SDSI-v1.1"),
);
...
const NSE5securenetworking = lazy(
  () => import("../pages/training/fortinet/nse5securenetworking"),
);
const NSE5CloudSecurity = lazy(
  () => import("../pages/training/fortinet/nse5cloudsecurity"),
);
const NSE5SASE = lazy(() => import("../pages/training/fortinet/nse5sase"));
const NSE5SecurityOperations = lazy(
  () => import("../pages/training/fortinet/nse5securityoperations"),
);
const NSE6SecureNetworking = lazy(
  () => import("../pages/training/fortinet/nse6securenetworking"),
);
...
const PaloaltoApprentice = lazy(
  () => import("../pages/training/paloalto/networksecurity/apprentice"),
);
const PaloaltoPractitioner = lazy(
  () => import("../pages/training/paloalto/networksecurity/practitioner"),
);
const NetworkSecurityProfessional = lazy(
  () => import("../pages/training/paloalto/networksecurity/professional"),
);
const NextGenerationFirewallEngineer = lazy(
  () =>
    import("../pages/training/paloalto/networksecurity/nextgenerationfirewallengineer"),
);
const SDWanEngineer = lazy(
  () => import("../pages/training/paloalto/networksecurity/sdwanengineer"),
);
const SecurityServiceEdgeEngineer = lazy(
  () =>
    import("../pages/training/paloalto/networksecurity/securityserviceedgeengineer"),
);
const NetworkSecurityAnalyst = lazy(
  () => import("../pages/training/paloalto/networksecurity/analyst"),
);
const NetworkSecurityArchitect = lazy(
  () => import("../pages/training/paloalto/networksecurity/architect"),
);
const SecurityOperationsProfessional = lazy(
  () => import("../pages/training/paloalto/securityoperations/professional"),
);
const XsiamAnalyst = lazy(
  () => import("../pages/training/paloalto/securityoperations/xsiamanalyst"),
);
const XDRAnalyst = lazy(
  () => import("../pages/training/paloalto/securityoperations/xdranalyst"),
);
const XsiamEngineer = lazy(
  () => import("../pages/training/paloalto/securityoperations/xsiamengineer"),
);
const XDREngineer = lazy(
  () => import("../pages/training/paloalto/securityoperations/xdrengineer"),
);
const XsoarEngineer = lazy(
  () => import("../pages/training/paloalto/securityoperations/xsoarengineer"),
);
const CloudSecurityProfessional = lazy(
  () => import("../pages/training/paloalto/cloudsecurity/professional"),
);
...
/* Cloud */
const AzureFundamentals = lazy(
  () => import("../pages/training/cloud/microsoft/azurefundamentals"),
);
    ...
    <>
      ...
      >
        <Routes>
          ...
          <Route
            path="/training/comptia/security+"
