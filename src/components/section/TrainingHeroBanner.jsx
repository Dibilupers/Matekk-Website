...
export default function HeroBanner({ bgImage, category, title, description }) {
  return (
    <>
      {/* ==================== HERO BANNER ====================*/}
      <section className="relative pl-4 py-16 rounded-2xl shadow-lg flex flex-col gap-3 overflow-hidden min-h-62.5">
        {/* ==================== HERO BANNER - Image ====================*/}
        {/* Background Image */}
        <div
        ...
        <div className="relative z-10 flex flex-col gap-3 pl-1 sm:pl-8 overflow-x-auto">
          {/* Course Category */}
          ...
          <div className="space-y-1">
            {/* Course title */}
            <h1 className="text-[#1775EE] max-w-72 md:max-w-md 2xl:max-w-xl">{title}</h1>
